...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | As seguintes linhas de linguagem são usadas para trocar o nosso espaço reservado
    | de atributos por algo mais amigável ao leitor, como "Endereço de E-Mail"
    ...
    */
    ...
    'attributes' => [
        ...
        'password' => 'senha',
        'value' => 'valor',
        'destiny_city_id' => 'cidade de destino',
        'origin_city_id' => 'cidade de origem',
        'message' => 'mensagem',
        'title' => 'título',
        'text' => 'texto',
        'url' => 'link',
