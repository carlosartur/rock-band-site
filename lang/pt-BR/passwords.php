...
return [
    ...
    | aos motivos fornecidos pelo corretor de senhas para uma tentativa de 
    | atualização de senha, como falha devido a uma senha inválida ou token de redefinição.
    |
    */
